...
Updated ProffieOS Blade Styles are included in the `/Blade Styles/` directory in the Proffie folder. They're based on Fett263's style library styles and were hand tweaked by [crazy.hair](https://github.com/crazy-hair). More information and instructions on how to set them up can be found in the readme.md file in the `/Blade Styles/` directory.
